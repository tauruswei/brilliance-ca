...
var priKey = "-----BEGIN PRIVATE KEY-----\n" +
	"MIGTAgEAMBMGByqGSM49AgEGCCqBHM9VAYItBHkwdwIBAQQgzFjR8PHzla+2WJ/s\n" +
	"Ek5xTghMif/iuRrRkbea19dEoFmgCgYIKoEcz1UBgi2hRANCAASnJBe6kId7Y36r\n" +
	"rrYqjHNs0EJ+IcgC3nCLO+i+xSS+9Odiscu2mDCWCfAoKMfF4rMRHcIe31RwlMSQ\n" +
	"bD2HWuXy\n" +
	"-----END PRIVATE KEY-----\n"
